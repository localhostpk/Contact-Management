  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active"> Edit QR Code link </li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title"> Edit QR Code link</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
           <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form"action="{{route('edit.qr_code.user',$id)}}" method="post">
            	@csrf
              <div class="box-body">
              ...
              <div class="box-footer">
                <button type="submit" class="btn btn-primary">Edit QR Code link</button>
              </div>
            </form>
