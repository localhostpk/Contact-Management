  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">SMTP Details</li>
      </ol>
    </section>
      ...
      <div class="row">
        <div class="col-xs-12">
          ...
          @endif
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form"action="{{route('add.smtp.details')}}" method="post" enctype="multipart/form-data">
            	@csrf
              <div class="box-body">
                ...
                <select class="form-control select2" style="width: 100%;"name="status">
                  <option selected="selected" value="active">
                   ...
                   <option selected="selected" value="dis-active">
                    dis-active
                  </option>
                </select>
              </div>
              @if($errors->has('status'))
                ...
                @endif
                  ...
                  <input type="text" class="form-control"name="transport" id="exampleInputEmail1" placeholder="Enter transport">
                </div>
                ...
                @endif
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control"name="host" id="exampleInputEmail1" placeholder="Enter host">
                </div>
                 @if($errors->has('host'))
                ...
                @endif
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control"name="port" id="exampleInputEmail1" placeholder="Enter port">
                </div>
                 @if($errors->has('port'))
                ...
                @endif
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control"name="encryption" id="exampleInputEmail1" placeholder="Enter encryption type">
                </div>
                ...
                @endif
                 <div class="form-group">
                  ...
                  <input type="text" class="form-control"name="username" id="exampleInputEmail1" placeholder="Enter User Name">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"name="timeout" id="exampleInputEmail1" placeholder="Enter timeout">
                </div>
                    <div class="form-group">
                  <label for="exampleInputEmail1">Auth mode</label>
                  <input type="text" class="form-control"name="auth_mode" id="exampleInputEmail1" placeholder="Enter auth_mode">
                </div>
              </div>
