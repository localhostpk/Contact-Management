  ...
  <div class="content-wrapper">
   ...
   <section class="content-header">
      ...
      <ol class="breadcrumb">
        ...
        <li class="active">Edit Project Setting</li>
      </ol>
    </section>
        ...
        <div class="col-xs-12">
          <div class="box">
            <div class="box-header">
              <h3 class="box-title">Edit Project Setting</h3>
            </div>
            <!-- /.box-header -->
            <div class="box-body">
          ...
          @endif
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form"action="{{route('edit.project.details',$project->id)}}" method="post" enctype="multipart/form-data">
            	@csrf
              <div class="box-body">
                ...
                <select class="form-control select2" style="width: 100%;"name="status">
                  <option value="active" @if($project->status=="active")
                   ...
                   <option  value="dis-active" @if($project->status=="dis-active")
                     selected="selected"
                    @endif>
              ...
              @if($errors->has('status'))
                ...
                @endif
                  ...
                  <input type="text" class="form-control"name="pro_name" value="{{$project->pro_name}}" id="exampleInputEmail1" placeholder="Enter Project Name">
                </div>
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control"name="copyright_text"  value="{{$project->copyright_text}}"id="exampleInputEmail1" placeholder="Enter Copy Right test">
                </div>
